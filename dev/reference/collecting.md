...
- Instrument your R package or project using the
  [otel](https://github.com/r-lib/otel) package. Alternatively, use
  [Zero Code Instrumentation](https://otel.r-lib.org/reference/zci.html)
  to automatically instrument selected packages.
...
- See all [environment
  variables](https://otelsdk.r-lib.org/dev/reference/environmentvariables.md)
  and the manual of your chosen provider for details on configuring
  otelsdk exporters.
