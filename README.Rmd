...
<!-- badges: start -->
![lifecycle](https://lifecycle.r-lib.org/articles/figures/lifecycle-experimental.svg) [![R-CMD-check](https://github.com/r-lib/otelsdk/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/r-lib/otelsdk/actions/workflows/R-CMD-check.yaml)
...
[![Codecov test coverage](https://codecov.io/gh/r-lib/opentelemetry/graph/badge.svg)](https://app.codecov.io/gh/r-lib/opentelemetry)
<!-- badges: end -->
...
* Instrument your R package or project using the [otel](https://github.com/r-lib/otel) package.
* Choose an exporter from the otelsdk package. The `http` exporter sends OpenTelemetry output through OTLP/HTTP.
* Set the `OTEL_TRACES_EXPORTER` environment variable to point to the exporter of your choice.
  E.g. for OTLP/HTTP set `OTEL_TRACES_EXPORTER=http`.
